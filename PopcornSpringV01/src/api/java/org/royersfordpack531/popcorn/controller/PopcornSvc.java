package org.royersfordpack531.popcorn.controller;

import java.util.List;
import java.util.concurrent.CopyOnWriteArrayList;

import org.royersfordpack531.popcorn.client.PopcornSvcApi;
...
@Controller
public class PopcornSvc implements PopcornSvcApi {
...
//	private List<Video> videos = new CopyOnWriteArrayList<Video>();
	...
	/* BFTODO - Add POST support
	@RequestMapping(value=INVENTORY_SVC_PATH, method=RequestMethod.POST)
	...
	*/
	...
	// annotation.
	@RequestMapping(value=INVENTORY_SVC_PATH, method=RequestMethod.GET)
	public @ResponseBody int getInventoryCount(Popcorn type)
	{
		return 0;
	}
